...
friendlist = []
username = None
hmn_members = ["adh1999", "chase_currier", "erinje", "frosty_cow", "karklum", "mblackwood00", "nicholasprogers", "pumkinatorp", "reysolowalker", "zakhumphrey3200"]
...
def scrape_list_films(username, url):
    ...
    #filter movies_dict to only have hmn movies
    #print(hmn_movies_dict.get('title'))
    # store index of list items intersecting with hmn movies, then use index to pull ratings out
